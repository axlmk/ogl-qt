...
class App3DViewer : public QMainWindow
{
   ...
   private slots:
	...
	void _selectedObjectChanged(SceneObject* selectedObject);

   private:
	SceneViewer* m_sceneViewer;		///< The Qt OpenGL scene
	SceneObject* m_selectedObject;	///< The currently selected object in the scene, nullptr if no object is selected
